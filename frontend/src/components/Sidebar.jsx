              ...
              <ul className="pt-2 pb-4 space-y-1 text-sm">
                ...
                <li className="rounded-sm">
                  ...
                  >
                    ...
                    <span className="text-gray-100">Laporan</span>
                  </Link>
                </li>
                <li className="rounded-sm">
                  <Link
                  ...
                  >
                    ...
                    <span className="text-gray-100">Pengajuan Jaminan</span>
                  </Link>
                </li>
                <li className="rounded-sm">
                  <Link
                ...
                <li className="rounded-sm">
                  ...
                  >
                    ...
                    <span className="text-gray-100">Data Jaminan</span>
                  </Link>
                </li>
                <li className="rounded-sm">
                  <Link
                  ...
                  >
                    ...
                    <span className="text-gray-100">Data Surety Bond</span>
                  </Link>
                </li>
                <li className="rounded-sm">
                  <Link
                  ...
                  >
                    ...
                    <span className="text-gray-100">Manajemen User</span>
                  </Link>
                </li>
                <li className="rounded-sm">
                  <Link
